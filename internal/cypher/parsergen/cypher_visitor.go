...
type CypherVisitor interface {
	...
	// Visit a parse tree produced by CypherParser#oC_SubqueryCall.
	VisitOC_SubqueryCall(ctx *OC_SubqueryCallContext) interface{}
	...
	VisitOC_NonArithmeticOperatorExpression(ctx *OC_NonArithmeticOperatorExpressionContext) interface{}
	...
	// Visit a parse tree produced by CypherParser#oC_Reduce.
	VisitOC_Reduce(ctx *OC_ReduceContext) interface{}
	...
	// Visit a parse tree produced by CypherParser#oC_ExistentialMatchQuery.
	VisitOC_ExistentialMatchQuery(ctx *OC_ExistentialMatchQueryContext) interface{}
